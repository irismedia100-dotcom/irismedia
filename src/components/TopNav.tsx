...
export const TopNav: React.FC<TopNavProps> = ({ activeCategory, onSelectCategory }) => {
  return (
    <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-neutral-100 py-4 px-6 md:px-10 flex items-center justify-end select-none">
